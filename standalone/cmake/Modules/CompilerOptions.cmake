...
# Detect Clang-CL (Clang with MSVC-like command line)
set(USING_CLANG_CL OFF)
IF(MSVC AND (CMAKE_CXX_COMPILER_ID STREQUAL "Clang" OR CMAKE_C_COMPILER_ID STREQUAL "Clang"))
  set(USING_CLANG_CL ON)
  message(STATUS "Detected Clang-CL compiler")
  # Clang-CL needs explicit exception handling enabled
...
IF(MSVC)
  ...
  # For Clang-CL, don't use /WX (warnings as errors) to avoid third-party library issues
  IF(USING_CLANG_CL)
...
set(MESHLIB_PYBIND11_LIB_SUFFIX "meshlib_standalone" CACHE STRING "")
